...
<style scope>
  ...
  .btn>.btn-original {
    ...
    font-weight: bold;
    transition: margin 0.15s, padding 0.15s, font-size 0.15s, right 0.15s, top 0.15s;
  }
  .btn.original {
    color:transparent;
  }
  ...
  .kb-row, .btn-row1, .btn-row2, .btn-row3, .btn-row4 {
    height: 38pt;
  }
  .btn-row1 {
    padding: 0;
    margin: 0;
    display: block;
    width: calc(var(--rowWidth) / 10);
  }
  .btn-row2 {
    padding: 0;
    margin: 0;
    display: block;
    width: calc(var(--rowWidth) / 9);
  }
  .btn-row3 {
    padding: 0;
    margin: 0;
